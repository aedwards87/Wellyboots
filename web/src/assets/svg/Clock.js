...
const Clock = ({ className, width = "53", height = "53", colorOne = "dark", colorTwo = "light", ...props }) => {
  return (
    <Container
      className={className}
      width={width}
    ...
    >
      ...
      <path d="M33.5211 37.9111L32.3394 38.5811L35.0527 43.3562L36.2345 42.6863L33.5211 37.9111Z" className="colorOne" />
      <path d="M38.4621 32.4563L37.7915 33.6367L42.5723 36.3463L43.2429 35.166L38.4621 32.4563Z" className="colorOne" />
      ...
      <path d="M35.2958 9.25715L32.5203 13.9966L33.6932 14.6818L36.4688 9.94239L35.2958 9.25715Z" className="colorOne" />
      <path d="M39.9629 25.4802L39.9568 26.8374L45.4538 26.8622L45.46 25.505L39.9629 25.4802Z" className="colorOne" />
      <path d="M42.6036 16.1185L37.8223 18.8281L38.4928 20.0086L43.2742 17.299L42.6036 16.1185Z" className="colorOne" />
    </Container>
  )
}
